...
# Test 2: Path-based Routing & Ingress Gateway Security (AuthorizationPolicy)
# Note: VirtualService is now automatically created by KServe using the pathTemplate configuration
